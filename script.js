...
// it fetches meals from the api and return it
      ...
      data.meals.forEach((element) => {
        ...
        if (isFav) {
          ...
          <div id="card" class="card mb-3" style="width: 20rem;">
                ...
                <div class="card-body">
                <h5 class="card-title " stylle="color:white;">${element.strMeal}</h5>
          ...
          <div id="card" class="card mb-3" style="width: 20rem;">
                <img src="${element.strMealThumb}" class="card-img-top" alt="...">
                <div class="card-body">\
                <h5 class="card-title" style="color:white;">${element.strMeal}</h5>
                <div class="d-flex justify-content-between mt-5">
                <button type="button" class="btn btn-warning" onclick="showMealDetails(${element.idMeal})">Recipe</button>
...
async function showMealDetails(id) {
  ...
  await fetchMealsFromApi(url, id).then((data) => {
    html += `
        ...
        <div id="menu" class="card p-lg-5 p-md-2">
        <div class="row ">
        ...
        <h2 style="color:white" class="card-title" id="heading2">${data.meals[0].strMeal}</h2>
        <p id="category" style="color:white">Category : ${data.meals[0].strCategory}</p>
        <p id="area" style="color:white">Area : ${data.meals[0].strArea}</p>
        <h5 style="color:white">Instruction :</h5>
